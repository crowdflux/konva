suite('PolyLine', function() {
    // ======================================================
    test('add polyline', function() {
      var stage = addStage();
    ...
    test('test default ponts array for two lines', function() {
      ...
      var redLine = new Konva.PolyLine({
        x: 50,
        stroke: 'red',
        strokeWidth: 20,
        lineCap: 'round',
    ...
    // ======================================================
    test('add polyline with shadow', function() {
      var stage = addStage();
      var layer = new Konva.Layer();
    ...
    test('line hit test with strokeScaleEnabled = false', function() {
      ...
      assert.equal(shape, line2, 'second polyline detected');
  
      shape = layer.getIntersection({
        x: 10,
        y: 4
      });
      assert.equal(shape, line1, 'first polyline detected');
    });
